...
class RegisterForm(FlaskForm):
    ...
    icon = RadioField('Avatar', choices=[(random1,r1_img),(random2,r2_img),(random3,r3_img),(random4,r4_img),(random5,r5_img),(random6,r6_img),(random7,r7_img),(random8,r8_img)], validators=[DataRequired()])
...
class EditProfileForm(FlaskForm):
    ...
    icon = RadioField('Avatar', choices=[(8001,"Don't Change"),(random1,r1_img),(random2,r2_img),(random3,r3_img),(random4,r4_img),(random5,r5_img),(random6,r6_img),(random7,r7_img),(random8,r8_img)], validators=[DataRequired()])
